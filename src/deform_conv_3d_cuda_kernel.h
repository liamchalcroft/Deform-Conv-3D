...
void deformable_col2im_coord(cudaStream_t stream, const DType *data_col,
                             ...
                             const int width, const int depth, const int ksize_h,
                             const int ksize_w, const int ksize_d, const int pad_h,
                             const int pad_w, const int pad_d, const int stride_h,
                             const int stride_w, const int stride_d, const int dilation_h,
                             const int dilation_w, const int dilation_d, const int parallel_imgs,
