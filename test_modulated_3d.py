...
def example_dconv():
    ...
    input = torch.randn(2, 64, 128, 128, 128).cuda()
...
def example_dpooling():
    ...
    input = torch.randn(2, 32, 64, 64, 64).cuda()
    batch_inds = torch.randint(2, (20, 1)).cuda().float()
    x = torch.randint(256, (20, 1)).cuda().float()
    y = torch.randint(256, (20, 1)).cuda().float()
    z = torch.randint(256, (20, 1)).cuda().float()
    w = torch.randint(64, (20, 1)).cuda().float()
    h = torch.randint(64, (20, 1)).cuda().float()
    d = torch.randint(64, (20, 1)).cuda().float()
    rois = torch.cat((batch_inds, x, y, z, x + w, y + h, z + d), dim=1)
    offset = torch.randn(20, 2, 7, 7, 7).cuda()
